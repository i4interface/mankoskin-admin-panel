                ...
                <div className="bg-white dark:bg-black h-full">
                    <div className="flex justify-between items-center px-4 py-3">
                        <NavLink to="/" className="main-logo flex items-center shrink-0">
                            <img className="w-8 ml-[5px] flex-none" src="/assets/images/mankoskin-favicon.png" alt="logo" />
                            <span className="text-2xl ltr:ml-1.5 rtl:mr-1.5 font-semibold align-middle lg:inline dark:text-white-light">{t('MankoSkin')}</span>
                        </NavLink>
                        ...
                        <ul className="relative font-semibold space-y-0.5 p-4 py-0">
                            <li className="menu nav-item">
                                <button type="button" className={`${currentMenu === 'dashboard' ? 'active' : ''} nav-link group w-full`} onClick={() => toggleMenu('dashboard')}>
                                    ...
                                    <div className={currentMenu !== 'dashboard' ? 'rtl:rotate-90 -rotate-90' : ''}>{/* <IconCaretDown /> */}</div>
                                </button>
                      ...
                      <NavLink to="/crypto">{t("crypto")}</NavLink>
                            ...
                            <li className="menu nav-item">
                                ...
                                <AnimateHeight duration={300} height={currentMenu === 'invoice' ? 'auto' : 0}>
                                    <ul className="sub-menu text-gray-500">
                                        <li>
                                            <NavLink to="/apps/invoice/list">{t('All products')}</NavLink>
                                        </li>
                                        <li>
                                            <NavLink to="/apps/invoice/preview">{t('Category')}</NavLink>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            <NavLink to="">{t('Inventory')}</NavLink>
                                        </li>
                                    </ul>
                                </AnimateHeight>
                            </li>
                            ...
                            <li className="nav-item">
                                <ul>
                                    ...
                                    <li className="nav-item">
                                        <NavLink to="/datatables/multi-column" className="group">
                                            <div className="flex items-center">
                                    ...
                                    <li className="nav-item">
                                        <NavLink to="" className="group">
                                            <div className="flex items-center">
                                                ...
                                                <span className="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">{t('Our Staff')}</span>
                                            </div>
                                        </NavLink>
                                    </li>
                                    <li className="nav-item">
