                ...
                <div className="w-full sm:w-auto grid grid-cols-2 sm:grid-cols-4 gap-3 mt-4">
                  <button
                    ...
                    className={`btn btn-outline-primary flex ${
                      selectedTab === "personal" ? "text-white bg-primary" : ""
                    }`}
                    onClick={() => {
                  ...
                  <button
                    ...
                    className={`btn btn-outline-warning flex ${
                      selectedTab === "work" ? "text-white bg-warning" : ""
                    }`}
                    onClick={() => {
                      setSelectedTab("work")
                      tabChanged("work")
                  ...
                  <button
                    ...
                    className={`btn btn-outline-success flex ${
                      selectedTab === "social" ? "text-white bg-success" : ""
                    }`}
                    onClick={() => {
                  ...
                  <button
                    ...
                    className={`btn btn-outline-danger flex ${
                      selectedTab === "private" ? "text-white bg-danger" : ""
                    }`}
                    onClick={() => {
                        ...
                        return (
                          ...
                          >
                                ...
                                <div className="ltr:mr-3 rtl:ml-3">
                                  <Tippy content="Important">
                                    ...
                                    >
                                      <IconBookmark
                                        bookmark={false}
                                        className={`w-4.5 h-4.5 ${mail.isImportant &&
                                          "fill-primary"}`}
                                      />
                                    </button>
                                  </Tippy>
                            ...
                            <td>
                              <div className="flex items-center">
                                <div
                                  className={`w-2 h-2 rounded-full ${(mail.group ===
                                    "personal" &&
                                    "bg-primary") ||
                    ...
                    <div className="flex items-center">
                      ...
                      {selectedMail.group && (
                        <div className="ltr:mr-4 rtl:ml-4">
                          ...
                          >
                            <div
                              className={`w-2 h-2 rounded-full ${(selectedMail.group ===
                                "personal" &&
                                "bg-primary") ||
                          ...
                          <ul className="sm:w-56">
                            <li>
                              <div className="flex items-center px-4 py-2">
                                <div className="text-white-dark ltr:mr-2 rtl:ml-2 w-1/4">
                                  From:
                                </div>
                    ...
                    <div className="flex items-center justify-center space-x-3 rtl:space-x-reverse">
                      ...
                      <Tippy content="Important">
                        ...
                        >
                          <IconBookmark
                            bookmark={false}
                            className={`w-4.5 h-4.5 rotate-90 ${selectedMail.isImportant &&
                              "fill-primary"}`}
                          />
                        </button>
                      </Tippy>
          ...
          {isEdit && (
            <div className="relative">
              <div className="py-4 px-6 flex items-center">
                ...
                <h4 className="text-lg text-gray-600 dark:text-gray-400 font-medium">
                  Message
                </h4>
              </div>
