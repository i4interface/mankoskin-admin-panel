  ...
  return (
    <div>
      <div className="flex gap-5 relative sm:h-[calc(100vh_-_150px)] h-full">
        <div
          className={`panel p-4 flex-none w-[240px] max-w-full absolute xl:relative z-10 space-y-4 xl:h-auto h-full xl:block ltr:xl:rounded-r-md ltr:rounded-r-none rtl:xl:rounded-l-md rtl:rounded-l-none hidden ${isShowTaskMenu &&
            "!block"}`}
        >
          <div className="flex flex-col h-full pb-16">
            ...
            <PerfectScrollbar className="relative ltr:pr-3.5 rtl:pl-3.5 ltr:-mr-3.5 rtl:-ml-3.5 h-full grow">
              <div className="space-y-1">
                ...
                <button
                  type="button"
                  className={`w-full flex justify-between items-center p-2 hover:bg-white-dark/10 rounded-md dark:hover:text-primary hover:text-primary dark:hover:bg-[#181F32] font-medium h-10 ${selectedTab ===
                    "complete" &&
                    "bg-gray-100 dark:text-primary text-primary dark:bg-[#181F32]"}`}
                  onClick={() => {
                    tabChanged()
                ...
                <button
                  type="button"
                  className={`w-full flex items-center h-10 p-1 hover:bg-white-dark/10 rounded-md dark:hover:bg-[#181F32] font-medium text-success ltr:hover:pl-3 rtl:hover:pr-3 duration-300 ${selectedTab ===
                    "team" &&
                ...
                <button
                  type="button"
                  className={`w-full flex items-center h-10 p-1 hover:bg-white-dark/10 rounded-md dark:hover:bg-[#181F32] font-medium text-warning ltr:hover:pl-3 rtl:hover:pr-3 duration-300 ${selectedTab ===
                    "low" &&
                    "ltr:pl-3 rtl:pr-3 bg-gray-100 dark:bg-[#181F32]"}`}
                  onClick={() => {
                    tabChanged()
                ...
                <button
                  type="button"
                  className={`w-full flex items-center h-10 p-1 hover:bg-white-dark/10 rounded-md dark:hover:bg-[#181F32] font-medium text-primary ltr:hover:pl-3 rtl:hover:pr-3 duration-300 ${selectedTab ===
                    "medium" &&
                    "ltr:pl-3 rtl:pr-3 bg-gray-100 dark:bg-[#181F32]"}`}
                  onClick={() => {
                    tabChanged()
                ...
                <button
                  type="button"
                  className={`w-full flex items-center h-10 p-1 hover:bg-white-dark/10 rounded-md dark:hover:bg-[#181F32] font-medium text-danger ltr:hover:pl-3 rtl:hover:pr-3 duration-300 ${selectedTab ===
                    "high" &&
                    "ltr:pl-3 rtl:pr-3 bg-gray-100 dark:bg-[#181F32]"}`}
                  onClick={() => {
                    tabChanged()
                ...
                <button
                  type="button"
                  className={`w-full flex items-center h-10 p-1 hover:bg-white-dark/10 rounded-md dark:hover:bg-[#181F32] font-medium text-info ltr:hover:pl-3 rtl:hover:pr-3 duration-300 ${selectedTab ===
                    "update" &&
                    "ltr:pl-3 rtl:pr-3 bg-gray-100 dark:bg-[#181F32]"}`}
                  onClick={() => {
                    tabChanged()
        ...
        <div
          className={`overlay bg-black/60 z-[5] w-full h-full rounded-md absolute hidden ${isShowTaskMenu &&
            "!block xl:!hidden"}`}
                        ...
                        >
                          ...
                          <td>
                            <div onClick={() => viewTask(task)}>
                              ...
                              <div
                                className={`text-white-dark overflow-hidden min-w-[300px] line-clamp-1 ${
                                  task.status === "complete"
                                    ? "line-through"
                                    : ""
                                }`}
